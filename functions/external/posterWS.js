...
class Poster {
  constructor(id, password) {
    ...
    this.jobRef = null
    /** 預設較鬆，減少 Firestore 寫入；Functions 可覆寫 progressThrottleMs / progressMinPercentDelta */
    this._progressThrottleMs = 10000
    this._progressMinPercentDelta = 12
  ...
  */
  ...
  postArticle = (options) => {
    ...
    this._progressThrottleMs =
      typeof progressThrottleMs === 'number' ? progressThrottleMs : 10000
